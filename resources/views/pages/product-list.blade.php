					...
					<div class="col-12">
						<div class="bread-inner">
							<ul class="bread-list">
								...
								<li class="active"><a href="">Danh sách dòng</a></li>
							</ul>
						</div>
					</div>
				</div>
								...
								<div class="single-widget category">
									...
									<ul class="categor-list">
										@foreach($category as $cate)
                                                    <li><a href="{{route('products_category_list',[$cate->idDanhMuc])}}">{{$cate->TenDanhMuc}}</a></li> 
                                                    @endforeach  
									</ul>
								</div>
								<!--/ End Single Widget -->
								...
								<div class="single-widget recent-post">
									...
									<div class="single-post first">
										...
										<div class="content">
											...
											<p class="price">{{number_format($item['productInfo']->Gia,0,",",".")}} VNĐ</p>
											{{-- <ul class="reviews">
						...
						<div class="row">
							<div class="col-12">
								...
								<div class="shop-top">
									...
									<ul class="view-mode">
										<li><a href="{{route('products_category_grid',[$idCategory])}}"><i class="fa fa-th-large"></i></a></li>
										<li class="active"><a href="{{route('products_category_list',[$idCategory])}}"><i class="fa fa-th-list"></i></a></li>
									</ul>
									</div>
										...
										<div class="col-lg-8 col-md-6 col-12">
											<div class="list-content">
												<div class="product-content">
													...
													<h3 class="title"><a href="{{('../detail_product/'.$sp->idSanPham)}}">{{$sp->TenSanPham}}</a></h3>
													<div class="review-inner">
														<div class="ratings">
															<ul class="rating">
																@php

																if (count($sp->danhgia)>0){
           															 $num = 0;
             															$tong_sao = 0;
        													foreach ($sp->danhgia as $key => $sao) {
           															$num++;
           															$tong_sao+=$sao->SoSao;
        
        															$review_avg=$tong_sao/$num;
        															}
        														}else{
            														$review_avg=0;
        														}
                                                        ...
                                                        @endif
																...
																<li class="total">({{$review_avg}} sao)</li>
															</ul>
														</div>
													</div>
												</div>
												<p class="des">{{$sp->MoTaNgan}}</p>
												<a href="{{('../detail_product/'.$sp->idSanPham)}}" class="btn">Xem chi tiết!</a>
											</div>
										</div>

...
(function(h) {
        ...
        if (-1 !== h.inArray(!1, b))
            ...
            if (0 !== i.length) {
                ...
                for (j = j ? 0 : g; j < f; j++) {
                    ...
                    if (0 !== e) {
                        var G = d[c % e];
                        q._sRowStripe != G && (h(r).removeClass(q._sRowStripe).addClass(G),
                            q._sRowStripe = G)
                    }
    ...
    l.defaults = {
        ...
        oLanguage: {
            ...
            sInfo: "Đang hiển thị _START_ đến _END_ của _TOTAL_ chỉ mục",
            sInfoEmpty: "Hiển thị 0 đến 0 của 0 chỉ mục",
            sInfoFiltered: "(Đã lọc từ _MAX_ tổng chỉ mục)",
            sInfoPostFix: "",
            sDecimal: "",
            sThousands: ",",
            sLengthMenu: "Hiển thị _MENU_ chỉ mục",
